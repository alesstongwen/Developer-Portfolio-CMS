...
@section('content')
<div class="max-w-4xl mx-auto mt-10 px-6 py-12">
    ...
    <a href="{{ route('projects.create') }}" class="bg-green-600 text-green px-4 py-2 rounded mb-4 inline-block">+ Add New Project</a>
